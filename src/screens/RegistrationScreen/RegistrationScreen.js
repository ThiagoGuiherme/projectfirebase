...
export default function RegistrationScreen({ navigation }) {
  ...
  const [fullSobrenome, setFullSobrenome] = useState('')
  const [fullDataNascimento, setFullDataNascimento] = useState('')
  const [fullGenero, setFullGenero] = useState('')
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <TextInput
          ...
          placeholderTextColor="#aaaaaa"
          onChangeText={text => setFullSobrenome(text)}
          value={fullSobrenome}
          underlineColorAndroid="transparent"
          autoCapitalize="none"
        />
        <TextInput
          ...
          placeholderTextColor="#aaaaaa"
          onChangeText={text => setFullDataNascimento(text)}
          value={fullDataNascimento}
          underlineColorAndroid="transparent"
          autoCapitalize="none"
        />
        <TextInput
